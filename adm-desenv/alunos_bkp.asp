...
'					<%
				...
				case "certificado":
						...
						while not RS.EOF
							...
							pdf.SetY(1)
							pdf.SetX(1)
							pdf.Image "img/certificado_frente.jpg",1,1,300,210,"JPG"
							...
							pdf.SetY(1)
							pdf.SetX(1)
							pdf.Image "img/certificado_verso.jpg",1,1,300,210,"JPG"
							pdf.SetFont "Arial","",11
							pdf.SetY(20)
							pdf.SetX(40)
...
' pdf_frente ="Certificado_"&RS("COD_ALUNO")&"_"&RS("COD_CURSO")&"_"&RS("ID_TURMA")&".pdf"
' pdf_verso  ="Certificado_"&RS("COD_ALUNO")&"_"&RS("COD_CURSO")&"_"&RS("ID_TURMA")&".pdf"

' dim fs
' set fs=Server.CreateObject("Scripting.FileSystemObject")
' fs.CopyFile "pdf_frente,"arq_pdf"
' set fs=nothing
...
<!----				<td class="header"><a href="alunos.asp?ord=cp&cod=<%=cod%>&st=<%=st%>">Nome Instituição</a></td> ---->
    				...
    				<td class="header"><a href="alunos.asp?ord=ap&cod=<%=cod%>&st=<%=st%>">Bioma</a></td>
    				<td class="header"><a href="alunos.asp?ord=ap&cod=<%=cod%>&st=<%=st%>">Adesão</a></td>
