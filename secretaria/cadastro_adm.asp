...
<head>
	...
	if session("pass")="ok" then
		...
		'response.end
		sql = "SELECT * FROM ALUNO WHERE COD_ALUNO="&session("id")
'		response.write sql
'		response.end
...
<div id="pagina">
	<!-- #INCLUDE FILE="topo_visitante.asp" -->
	<div id="conteudo">
	<h1>FORMULÁRIO DE CADASTRO DE VISITANTES</h1><p><br /></p>
	<p><br /></p>
	...
	<%else%>
		...
		<fieldset>
			...
			<p><label for="FAX">DDI / DDD / Fax</label><input type="text" name="FAX_DDI" id="FAX_DDI" maxlength="3" size="4" value="<%=FAX_DDI%>" onKeyPress="return ValidateKeyPressed('INT', this, event);"> / <input type="text" name="FAX_DDD" id="FAX_DDD" maxlength="3" size="4" value="<%=FAX_DDD%>" onKeyPress="return ValidateKeyPressed('INT', this, event);"> / <input type="text" name="FAX" id="FAX" maxlength="9" size="20" value="<%=FAX%>"></p>
		</fieldset>
		<p><br /></p>
		<fieldset>
