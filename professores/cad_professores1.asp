...
if Session("id") <> "" then
	cod = Session("id")
	RS.Open "SELECT * FROM PROFESSORES WHERE ID_PROFESSOR='"&Session("id")&"'"
...
<div id="pagina">
	...
	<link rel="stylesheet" type="text/css" href="../adm/css/styles.css" />
	<link rel="stylesheet" type="text/css" href="../adm/css/topo.css" />
	<!--[if IE]>
	<link rel="stylesheet" type="text/css" href="../css/topoIE.css" />
	<![endif]-->

	<div id="topo">
		<div id="navdireita"><a href="javascript:window.close()">Fechar</a></div>
	</div>
	<div id="conteudo">
		<table border = 0 width=100%>
			<tr></td><td WIDTH="90%"><h1>Cadastre-se como professor do IBAM</h1></td></tr>
		</table>
		<form name="form" method="POST" action="salva_professores1.asp">
		<fieldset>
			<legend>Informações do professor</legend>
			<table width=100%>
			<tr><td nowrap><label for="CPF" class="requerido">CPF</label></td><td><input type="text" name="CPF" id="CPF" maxlength="14" size="30" value="<% =CPF %>"></td></tr>
			<tr><td nowrap><label for="SENHA" class="requerido">Senha</label></td><td><input type="text" name="SENHA" id="SENHA" maxlength="14" size="30" value="<% =SENHA %>"></td></tr>
			...
			<tr><td nowrap><label for="TELEFONERES" class="requerido">Telefone Residencial</label></td><td><input type="text" name="TELEFONERES" id="TELEFONERES" maxlength="14" size="20" value="<%=formatatel(TELEFONERES)%>"></td></tr>
		...
		<fieldset>
			...
			<tr><td nowrap><label for="FORMACAO">Área (especificar)</label></td><td><input type="text" name="FORMACAO" id="FORMACAO" maxlength="250" size="60" value="<%=FORMACAO%>"></td></tr>
			<tr><td><br></td></tr>
