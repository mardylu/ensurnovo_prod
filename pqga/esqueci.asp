...
<%ELSE%>
	...
	IF erro=0 THEN
        MSG = "Sua senha para o sistema de Capacitação da Gestão Ambiental é: <b>" & SENHA  & "</b><br><br>"        & _
              "(utilize a senha em negrito para acessar o site e fazer sua pré-inscrição)"
		mailErr=envia_emailhtml(E_MAIL,"pqga-ead@ibam.org.br",MSG," Capacitação da Gestão Ambiental - Pedido de senha")
		%>
