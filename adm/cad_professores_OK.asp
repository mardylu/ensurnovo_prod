...
<div id="pagina">
	...
	<div id="conteudo">
		...
		<fieldset>
			...
			<tr><td nowrap>
			<label for="STATUS_PROFESSOR" class="requerido">Status do Professor</label></td><td><input type="text" name="STATUS_PROFESSOR" id="STATUS_PROFESSOR" maxlength="15" size="15" value="<%=STATUS_PROFESSOR%>">
			</td></tr>
		</table>
		</fieldset>
		<fieldset>
