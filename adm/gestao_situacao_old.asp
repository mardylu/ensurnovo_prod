...
'		if prioridade=""    or isNumeric(prioridade)=false  then prioridade=0
		...
		<h1>Relatório de alunos por turma</h1>                          <% ' Response.Write(Session("siga_projeto")) %>
		...
		<table id="tabela">
            ...
            <input type="text" name="cpf_aluno" id="cpf_aluno" maxlength="11" size="12"
                   value="<% if ( cpf_aluno = 0 ) then Response.Write("") else Response.Write(cpf_aluno) end if %>" > somente números
            </p>
