...
msql = "SELECT A.COD_UF_ENTI,A.COD_MUNI_ENTI,A.EMAIL_ENTI,A.ENDERECO_ENTI,A.CEP_ENTI,A.TEL_DDI_ENTI,A.TEL_DDd_ENTI,A.TEL_ENTI,A.NOME,CPF AS CPF,ID_TIPO,ID_NUM,DT_NASCIMENTO AS DT_NASCIMENTO,SEXO,isNull(R.DESCRICAO,'') AS RACA,P.NOME AS PAIS,EMAIL,ENDERECO,CEP,isNull(COD_MUNI_IBGE,0) AS COD_MUNI_IBGE,isNull(COD_UF_IBGE,0) AS COD_UF_IBGE,TEL_DDI,TEL_DDD,TEL,FAX_DDI,FAX_DDD,FAX,E.DESCRICAO AS ESCOLARIDADE,FORMACAO,POS.DESCRICAO AS POS,POS AS POS_AREA,NEWSLETTER,isNull((SELECT SUM(VALOR) FROM PAGAMENTO WHERE COD_ALUNO=C.COD_ALUNO AND ID_TURMA=C.ID_TURMA),0) AS VALOR_PAGO,C.DT_CADASTRO,isNull((SELECT MAX(DT_PGT) FROM PAGAMENTO WHERE COD_ALUNO=C.COD_ALUNO AND COD_CURSO=C.COD_CURSO),'') AS DT_PGT,C.APROVADO,C.COD_ENTI,C.CARGO,C.SETOR,C.TEL_DDI_ENTI,C.TEL_DDD_ENTI,C.TEL_ENTI,C.EMAIL_ENTI,C.ENDERECO_ENTI,C.CEP_ENTI,C.FORMA_PGT FROM TURMA_ALUNO C JOIN ALUNO A ON C.COD_ALUNO=A.COD_ALUNO LEFT JOIN ESCOLARIDADE E ON A.COD_ESCOLARIDADE=E.COD_ESCOLARIDADE LEFT JOIN RACA R ON A.COD_RACA=R.COD_RACA JOIN PAIS P ON A.COD_PAIS=P.COD_PAIS LEFT JOIN POS ON A.COD_POS=POS.COD_POS WHERE C.COD_ALUNO IN ("&sel&") AND "&msql
Response.ContentType = "application/vnd.ms-excel"
Response.AddHeader "Content-Disposition","attachment;filename=planilha.xls" & fn

if p="1" then
	Response.Write "<TABLE><tr><td><b>Nome</b></td><td><b>Tipo Instituição</b></td><td><b>Instituição</b></td><td><b>UF-ENTI</b></td><td><b>MUNI-ENTI</b></td><td><b>GEOCÓDIGO</b></td><td><b>UF IBGE</b></td><td><b>MUNI IBGE</b></td><td><b>GEOCÓDIGO</b></td><td><b>Setor</b></td><td><b>Cargo</b></td><td><b>Endereco Inst.</b></td><td><b>UF Inst.</b></td><td><b>Município Inst.</b></td><td><b>CEP Inst.</b></td><td><b>Tel inst.</b></td><td><b>Email inst.</b></td><td><b>Endereço</b></td><td><b>Município</b></td><td><b>UF</b></td><td><b>CEP</b></td><td><b>Tel</b></td><td><b>Fax</b></td><td><b>E-mail</b></td><td><b>Escolaridade</b></td><td><b>Nome do curso</b></td><td><b>Sexo</b></td><td><b>Nascimento</b></td><td><b>Raça</b></td><td><b>CPF</b></td><td><b>País</b></td><td><b>Pós</b></td><td><b>Área da pós</b></td></tr>"
else
	Response.Write "<TABLE><tr><td><b>Nome</b></td><td><b>Tipo Instituição</b></td><td><b>Instituição</b></td><td><b>UF-ENTI</b></td><td><b>MUNI-ENTI</b></td><td><b>GEOCÓDIGO</b></td><td><b>UF IBGE</b></td><td><b>MUNI IBGE</b></td><td><b>GEOCÓDIGO</b></td><td><b>Setor</b></td><td><b>Cargo</b></td><td><b>Endereco Inst.</b></td><td><b>UF Inst.</b></td><td><b>Município Inst.</b></td><td><b>CEP Inst.</b></td><td><b>Tel inst.</b></td><td><b>Email inst.</b></td><td><b>Endereço</b></td><td><b>Município</b></td><td><b>UF</b></td><td><b>CEP</b></td><td><b>Tel</b></td><td><b>Fax</b></td><td><b>E-mail</b></td><td><b>Escolaridade</b></td><td><b>Nome do curso</b></td><td><b>Sexo</b></td><td><b>Nascimento</b></td><td><b>Raça</b></td><td><b>CPF</b></td><td><b>País</b></td><td><b>Pós</b></td><td><b>Área da pós</b></td><td><b>Valor pago</b></td><td><b>Data cadastro</b></td><td><b>Data últ. pgt</b></td><td><b>Forma Pgt.</b></td><td><b>Aprovado</b></td></tr>"
end if
...
' Response.Write("uf"&cod_enti_uf_ibge)
' Response.Write("muni"&cod_enti_muni_ibge)
' Response.end
...
//				enti = enti & " ("&muni&"/"&uf&")"
	...
	if p="1" then
		Response.Write "<tr><td>"&RS("NOME")&"</td><td>"&desc&"</td><td>"&enti&"</td><td>"&cod_enti_uf_ibge&"</td><td>"&cod_enti_muni_ibge&"</td><td>"&geocod_enti&"</td><td>"&RS("COD_UF_IBGE")&"</td><td>"&RS("COD_MUNI_IBGE")&"</td><td>"&geocod_muni&"</td><td>"&RS("SETOR")&"</td><td>"&RS("CARGO")&"</td><td>"&RS("ENDERECO_ENTI")&"</td><td>"&uf&"</td><td>"&muni&"</td><td>"&RS("CEP_ENTI")&"</td><td>("&RS("TEL_DDI_ENTI")&"-"&RS("TEL_DDD_ENTI")&") "&RS("TEL_ENTI")&"</td><td>"&RS("EMAIL_ENTI")&"</td><td>"&RS("ENDERECO")&"</td><td>"&muniresid&"</td><td>"&ufresid&"</td><td>"&RS("CEP")&"</td><td>("&RS("TEL_DDI")&"-"&RS("TEL_DDD")&") "&RS("TEL")&"</td><td>("&RS("FAX_DDI")&"-"&RS("FAX_DDD")&") "&RS("FAX")&"</td><td>"&RS("EMAIL")&"</td><td>"&RS("ESCOLARIDADE")&"</td><td>"&RS("FORMACAO")&"</td><td>"&simnao(RS("SEXO"),true)&"</td><td> "&formataData(RS("DT_NASCIMENTO"))&"</td><td>"&RS("RACA")&"</td><td> "&CPF&"</td><td>"&RS("PAIS")&"</td><td>"&RS("POS")&"</td><td>"&RS("POS_AREA")&"</td></tr>"
	else
