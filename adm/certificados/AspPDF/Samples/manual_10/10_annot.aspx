...
void Page_Load(Object Source, EventArgs E)
{
	...
	// Put text annotation on page
	IPdfAnnot objAnnot = objPage.Annots.Add("This is a simple text annotation.", "x=10, y=700; width=200; height=50", Missing.Value, Missing.Value );

	// Save document, the Save method returns generated file name
	String strFilename = objDoc.Save( Server.MapPath("annot.pdf"), false );
