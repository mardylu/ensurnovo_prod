...
<head>
	...
	<script type="text/javascript">
		tinyMCE.init({
			...
			elements : "apresentacao1,objetivo1,conteudo1,publico1,minicurriculo,ementa",
			theme : "advanced",
...
<div id="pagina">
	...
	<div id="conteudo">
		...
		<fieldset>
			...
			<p><label for="FIC_VERSO" class="requerido">Verso do Certificado</label><textarea name="FIC_VERSO" cols="52" rows="6"><%=FIC_VERSO%></textarea>
            <a href="http://cursos.ibam.org.br/adm/ver_certificado.asp?cod=<%=request("tur")%>" target="_blank">Clique aqui para verificar a formatação do certificado.</a>
            </p>
