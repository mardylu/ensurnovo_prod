...
<%ELSE%>
	...
	ELSEIF erro=1 THEN
		%>
		<font face="Verdana" size=1 color="#7B8E92"><B>Login não encontrado no sistema. Favor contatar a administração do IBAM.</B>
		<br><BR><a href="javascript:window.close()">Fechar</a><br></font>
		<%
	ELSEIF erro=2 THEN
		%>
		<font face="Verdana" size=1 color="#7B8E92"><B>Não existe e-mail cadastrado para este login no sistema. Favor contatar a administração do IBAM.</B>
		<br><BR><a href="javascript:window.close()">Fechar</a><br></font>
		<%
	END IF
	%>
